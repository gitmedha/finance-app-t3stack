...
export const categoryMasterInFinanceProject = financeProject.table(
  "category_master",
  {
...
export const categoryHierarchyInFinanceProject = financeProject.table(
  "category_hierarchy",
  {
    id: serial("id").primaryKey().notNull(),
...
export const costCenterInFinanceProject = financeProject.table(
  "cost_center",
  {
    id: integer("id")
      .default(
        sql`nextval('finance_project.department_master_id_seq'::regclass)`,
      )
      .primaryKey()
      .notNull(),
...
export const departmentHierarchyInFinanceProject = financeProject.table(
...
export const departmentMasterInFinanceProject = financeProject.table(
  "department_master",
  {
    id: serial("id").primaryKey().notNull(),
  ...
  (table) => {
    return {
      ...
      departmentMasterDepartmentnameKey: unique(
        "department_master_departmentname_key",
      ).on(table.departmentname),
      departmentMasterDeptCodeKey: unique("department_master_dept_code_key").on(
        table.deptCode,
      ),
    };
  },
...
export const donorMasterInFinanceProject = financeProject.table(
  "donor_master",
  {
    id: serial("id").primaryKey().notNull(),
    ...
    budgetReceived: numeric("budget_received", {
      precision: 8,
      scale: 2,
    }).notNull(),
  ...
  (table) => {
    return {
      ...
      donorMasterDonorCodeKey: unique("donor_master_donor_code_key").on(
        table.costCenter,
      ),
    };
  },
...
export const budgetMasterInFinanceProject = financeProject.table(
  "budget_master",
  {
    id: serial("id").primaryKey().notNull(),
    name: varchar("name", { length: 255 }).notNull(),
  ...
  (table) => {
    return {
      ...
      budgetMasterVersionFinancialYearUnique: unique(
        "budget_master_version_financial_year_unique",
      ).on(table.name, table.financialYear),
    };
  },
);

export const staffMasterInFinanceProject = financeProject.table(
  "staff_master",
  {
    id: serial("id").primaryKey().notNull(),
...
export const tallyDepartmentInFinanceProject = financeProject.table(
  "tally_department",
  {
    id: serial("id").primaryKey().notNull(),
...
export const budgetDetailsInFinanceProject = financeProject.table(
  "budget_details",
  {
    id: serial("id").primaryKey().notNull(),
...
export const userMasterInFinanceProject = financeProject.table(
  "user_master",
  {
    id: serial("id").primaryKey().notNull(),
  ...
  (table) => {
    return {
      ...
      userMasterUsernameKey: unique("user_master_username_key").on(
        table.username,
      ),
    };
  },
...
export const tallyStaffInFinanceProject = financeProject.table(
  "tally_staff",
  {
    id: serial("id").primaryKey().notNull(),
    voucherName: varchar("voucher_name", { length: 25 }).notNull(),
...
export const locationMasterInFinanceProject = financeProject.table(
  "location_master",
  {
    id: serial("id").primaryKey().notNull(),
...
export const statesMasterInFinanceProject = financeProject.table(
  "states_master",
  {
    id: serial("id").primaryKey().notNull(),
...
export const tallyDonorInFinanceProject = financeProject.table(
  "tally_donor",
  {
    id: serial("id").primaryKey().notNull(),
    voucherName: varchar("voucher_name", { length: 25 }).notNull(),
