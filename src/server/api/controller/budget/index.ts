...
.input(z.object({
  ...
  export const addProgramOfficeBudgetDetails = protectedProcedure
.input(z.object({
    data: z.array(
      z.object({
        budgetid: z.number(),
  ...
  .input(z.object({
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      export const addOverHeadsBudgetDetails = protectedProcedure
.input(z.object({
    data: z.array(
      z.object({
        budgetid: z.number(),
      ...
      if (input.deptId == 0 || input.subDeptId == 0) {
        ...
        result = await ctx.db
          .select({
            ...
            aprTrips: sql`SUM(${budgetDetailsInFinanceProject.aprTrips})`.as(
              "aprTrips",
            ),
            mayTrips: sql`SUM(${budgetDetailsInFinanceProject.mayTrips})`.as(
              "mayTrips",
            ),
            junTrips: sql`SUM(${budgetDetailsInFinanceProject.junTrips})`.as(
              "junTrips",
            ),
            julTrips: sql`SUM(${budgetDetailsInFinanceProject.julTrips})`.as(
              "julTrips",
            ),
            augTrips: sql`SUM(${budgetDetailsInFinanceProject.augTrips})`.as(
              "augTrips",
            ),
            sepTrips: sql`SUM(${budgetDetailsInFinanceProject.sepTrips})`.as(
              "sepTrips",
            ),
            octTrips: sql`SUM(${budgetDetailsInFinanceProject.octTrips})`.as(
              "octTrips",
            ),
            novTrips: sql`SUM(${budgetDetailsInFinanceProject.novTrips})`.as(
              "novTrips",
            ),
            decTrips: sql`SUM(${budgetDetailsInFinanceProject.decTrips})`.as(
              "decTrips",
            ),
            janTrips: sql`SUM(${budgetDetailsInFinanceProject.janTrips})`.as(
              "janTrips",
            ),
            febTrips: sql`SUM(${budgetDetailsInFinanceProject.febTrips})`.as(
              "febTrips",
            ),
            marTrips: sql`SUM(${budgetDetailsInFinanceProject.marTrips})`.as(
              "marTrips",
            ),
            total: sql`SUM(${budgetDetailsInFinanceProject.total})`.as("total"),
            id: sql`SUM(${budgetDetailsInFinanceProject.total})`.as("total"),
      ...
      if (input.activity == "0") {
        ...
        result = await ctx.db
          .select({
            ...
            q3: sql`SUM(${budgetDetailsInFinanceProject.q3})`.as("q3"),
            q4: sql`SUM(${budgetDetailsInFinanceProject.q4})`.as("q4"),
            aprQty: sql`SUM(${budgetDetailsInFinanceProject.aprQty})`.as("aprQty"),
            aprRate: sql`SUM(${budgetDetailsInFinanceProject.aprRate})`.as("aprRate"),
            aprAmt: sql`SUM(${budgetDetailsInFinanceProject.aprAmt})`.as("aprAmt"),
            mayQty: sql`SUM(${budgetDetailsInFinanceProject.mayQty})`.as("mayQty"),
            mayRate: sql`SUM(${budgetDetailsInFinanceProject.mayRate})`.as("mayRate"),
            mayAmt: sql`SUM(${budgetDetailsInFinanceProject.mayAmt})`.as("mayAmt"),
            junQty: sql`SUM(${budgetDetailsInFinanceProject.junQty})`.as("junQty"), 
            junRate: sql`SUM(${budgetDetailsInFinanceProject.junRate})`.as("junRate"),
            junAmt: sql`SUM(${budgetDetailsInFinanceProject.junAmt})`.as("junAmt"),
            julQty: sql`SUM(${budgetDetailsInFinanceProject.julQty})`.as("julQty"),
            julRate: sql`SUM(${budgetDetailsInFinanceProject.julRate})`.as("julRate"),
            julAmt: sql`SUM(${budgetDetailsInFinanceProject.julAmt})`.as("julAmt"),
            augQty: sql`SUM(${budgetDetailsInFinanceProject.augQty})`.as("augQty"), 
            augRate: sql`SUM(${budgetDetailsInFinanceProject.augRate})`.as("augRate"),
            augAmt: sql`SUM(${budgetDetailsInFinanceProject.augAmt})`.as("augAmt"),
            sepQty: sql`SUM(${budgetDetailsInFinanceProject.sepQty})`.as("sepQty"),
            sepRate: sql`SUM(${budgetDetailsInFinanceProject.sepRate})`.as("sepRate"),
            sepAmt: sql`SUM(${budgetDetailsInFinanceProject.sepAmt})`.as("sepAmt"),
            octQty: sql`SUM(${budgetDetailsInFinanceProject.octQty})`.as("octQty"), 
            octRate: sql`SUM(${budgetDetailsInFinanceProject.octRate})`.as("octRate"),
            octAmt: sql`SUM(${budgetDetailsInFinanceProject.octAmt})`.as("octAmt"),
            novQty: sql`SUM(${budgetDetailsInFinanceProject.novQty})`.as("novQty"),
            novRate: sql`SUM(${budgetDetailsInFinanceProject.novRate})`.as("novRate"),
            novAmt: sql`SUM(${budgetDetailsInFinanceProject.novAmt})`.as("novAmt"),
            decQty: sql`SUM(${budgetDetailsInFinanceProject.decQty})`.as("decQty"), 
            decRate: sql`SUM(${budgetDetailsInFinanceProject.decRate})`.as("decRate"),
            decAmt: sql`SUM(${budgetDetailsInFinanceProject.decAmt})`.as("decAmt"),
            janQty: sql`SUM(${budgetDetailsInFinanceProject.janQty})`.as("janQty"),
            janRate: sql`SUM(${budgetDetailsInFinanceProject.janRate})`.as("janRate"),
            janAmt: sql`SUM(${budgetDetailsInFinanceProject.janAmt})`.as("janAmt"),
            febQty: sql`SUM(${budgetDetailsInFinanceProject.febQty})`.as("febQty"), 
            febRate: sql`SUM(${budgetDetailsInFinanceProject.febRate})`.as("febRate"),
            febAmt: sql`SUM(${budgetDetailsInFinanceProject.febAmt})`.as("febAmt"),
            marQty: sql`SUM(${budgetDetailsInFinanceProject.marQty})`.as("marQty"),
            marRate: sql`SUM(${budgetDetailsInFinanceProject.marRate})`.as("marRate"),
            marAmt: sql`SUM(${budgetDetailsInFinanceProject.marAmt})`.as("marAmt"),
            total: sql`SUM(${budgetDetailsInFinanceProject.total})`.as("total"),
            id: sql`SUM(${budgetDetailsInFinanceProject.total})`.as("total"),
          })
          .from(budgetDetailsInFinanceProject)
...
.input(
  ...
  export const updateProgramOfficeBudgetDetails = protectedProcedure
  .input(
      z.object({
        data: z.array(
          z.object({
    ...
    .input(
      ...
      export const updateOverHeadsBudgetDetails = protectedProcedure
      .input(
          z.object({
            data: z.array(
              z.object({
    ...
    z.object({
      ...
      data: z.array(
        z.object({
          ...
          description: z.string().optional(),
          aprQty: z.number().optional(),
          aprTrips: z.number().optional(),
          aprRate: z.number().optional(),
          aprAmt: z.number().optional(),
          april: z.number(),
          mayQty: z.number().optional(),
          mayTrips: z.number().optional(),
          mayRate: z.number().optional(),
          mayAmt: z.number().optional(),
          may: z.number(),
          junQty: z.number().optional(),
          junTrips: z.number().optional(),
          junRate: z.number().optional(),
          junAmt: z.number().optional(),
          june: z.number(),
          julQty: z.number().optional(),
          julTrips: z.number().optional(),
          julRate: z.number().optional(),
          julAmt: z.number().optional(),
          july: z.number(),
          augQty: z.number().optional(),
          augTrips: z.number().optional(),
          augRate: z.number().optional(),
          augAmt: z.number().optional(),
          august: z.number(),
          sepQty: z.number().optional(),
          sepTrips: z.number().optional(),
          sepRate: z.number().optional(),
          sepAmt: z.number().optional(),
          september: z.number(),
          octQty: z.number().optional(),
          octTrips: z.number().optional(),
          octRate: z.number().optional(),
          octAmt: z.number().optional(),
          october: z.number(),
          novQty: z.number().optional(),
          novTrips: z.number().optional(),
          novRate: z.number().optional(),
          novAmt: z.number().optional(),
          november: z.number(),
          decQty: z.number().optional(),
          decTrips: z.number().optional(),
          decRate: z.number().optional(),
          decAmt: z.number().optional(),
          december: z.number(),
          janQty: z.number().optional(),
          janTrips: z.number().optional(),
          janRate: z.number().optional(),
          janAmt: z.number().optional(),
          january: z.number(),
          febQty: z.number().optional(),
          febTrips: z.number().optional(),
          febRate: z.number().optional(),
          febAmt: z.number().optional(),
          february: z.number(),
          marQty: z.number().optional(),
          marTrips: z.number().optional(),
          marRate: z.number().optional(),
          marAmt: z.number().optional(),
          march: z.number(),
          activity: z.string().optional(),
      ...
      for (const item of data) {
        ...
        if (!existingRecord || existingRecord.length == 0) {
          recordsToInsert.push({
            ...
            description: item.description ?? null,
            aprQty: item.aprQty ?? 0,
            aprTrips: item.aprTrips ?? 0,
            aprRate: item.aprRate !== undefined ? String(item.aprRate) : "0",
            aprAmt: item.aprAmt !== undefined ? String(item.aprAmt) : "0",
            april: item.april !== undefined ? String(item.april) : "0",
            mayQty: item.mayQty ?? 0,
            mayTrips: item.mayTrips ?? 0,
            mayRate: item.mayRate !== undefined ? String(item.mayRate) : "0",
            mayAmt: item.mayAmt !== undefined ? String(item.mayAmt) : "0",
            may: item.may !== undefined ? String(item.may) : "0",
            junQty: item.junQty ?? 0,
            junTrips: item.junTrips ?? 0,
            junRate: item.junRate !== undefined ? String(item.junRate) : "0",
            junAmt: item.junAmt !== undefined ? String(item.junAmt) : "0",
            june: item.june !== undefined ? String(item.june) : "0",
            julQty: item.julQty ?? 0,
            julTrips: item.julTrips ?? 0,
            julRate: item.julRate !== undefined ? String(item.julRate) : "0",
            julAmt: item.julAmt !== undefined ? String(item.julAmt) : "0",
            july: item.july !== undefined ? String(item.july) : "0",
            augQty: item.augQty ?? 0,
            augTrips: item.augTrips ?? 0,
            augRate: item.augRate !== undefined ? String(item.augRate) : "0",
            augAmt: item.augAmt !== undefined ? String(item.augAmt) : "0",
            august: item.august !== undefined ? String(item.august) : "0",
            sepQty: item.sepQty ?? 0,
            sepTrips: item.sepTrips ?? 0,
            sepRate: item.sepRate !== undefined ? String(item.sepRate) : "0",
            sepAmt: item.sepAmt !== undefined ? String(item.sepAmt) : "0",
            september:
              item.september !== undefined ? String(item.september) : "0",
            octQty: item.octQty ?? 0,
            octTrips: item.octTrips ?? 0,
            octRate: item.octRate !== undefined ? String(item.octRate) : "0",
            octAmt: item.octAmt !== undefined ? String(item.octAmt) : "0",
            october: item.october !== undefined ? String(item.october) : "0",
            novQty: item.novQty ?? 0,
            novTrips: item.novTrips ?? 0,
            novRate: item.novRate !== undefined ? String(item.novRate) : "0",
            novAmt: item.novAmt !== undefined ? String(item.novAmt) : "0",
            november: item.november !== undefined ? String(item.november) : "0",
            decQty: item.decQty ?? 0,
            decTrips: item.decTrips ?? 0,
            decRate: item.decRate !== undefined ? String(item.decRate) : "0",
            decAmt: item.decAmt !== undefined ? String(item.decAmt) : "0",
            december: item.december !== undefined ? String(item.december) : "0",
            janQty: item.janQty ?? 0,
            janTrips: item.janTrips ?? 0,
            janRate: item.janRate !== undefined ? String(item.janRate) : "0",
            janAmt: item.janAmt !== undefined ? String(item.janAmt) : "0",
            january: item.january !== undefined ? String(item.january) : "0",
            febQty: item.febQty ?? 0,
            febTrips: item.febTrips ?? 0,
            febRate: item.febRate !== undefined ? String(item.febRate) : "0",
            febAmt: item.febAmt !== undefined ? String(item.febAmt) : "0",
            february: item.february !== undefined ? String(item.february) : "0",
            marQty: item.marQty ?? 0,
            marTrips: item.marTrips ?? 0,
            marRate: item.marRate !== undefined ? String(item.marRate) : "0",
            marAmt: item.marAmt !== undefined ? String(item.marAmt) : "0",
            march: item.march !== undefined ? String(item.march) : "0",
            activity: item.activity ?? null,
