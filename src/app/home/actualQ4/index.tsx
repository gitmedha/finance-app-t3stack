...
const ActualQ4 = ({ financialYear }: { financialYear: string }) => {
    ...
    const { data: q1data } = api.get.getQuarterBudgetSum.useQuery({ financialYear: financialYear, quarter: "q4",departmentId:userData.data?.user.departmentId }, { enabled: !!cat && !catsLoading })
            ...
            <table className="  min-w-full table-auto border-collapse p-2">
                <thead>
                    <tr className="bg-gray-200 text-gray-600 text-left text-sm uppercase">
                        ...
                        <th className="p-2">Actual Q4</th>
                        <th className="p-2"> Balance Q4</th>
                        <th className="p-2">Utilized Q4 %</th>
                        <th className="p-2">Budget Q4</th>
                    </tr>
                </thead>
                <tbody>
                    {
