    ...
    <div className="my-6 rounded-md bg-white shadow-lg">
      ...
      >
        <summary
          ...
          onClick={(e) => {
            e.preventDefault();
            if (sectionOpen == "PROGRAM OFFICE") setSectionOpen(null);
            else setSectionOpen("PROGRAM OFFICE");
          }}
        >
          ...
          {programOfficeDataLodaing ? (
            ...
            <div className="hidden w-5/6 gap-20 md:flex">
              ...
              <div className="w-1/6 rounded-md border border-primary/20 bg-primary/5 px-5 py-1">
