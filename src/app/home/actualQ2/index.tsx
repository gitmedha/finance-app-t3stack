...
const ActualQ2 = ({ financialYear }: { financialYear: string }) => {
    ...
    const { data: q1data } = api.get.getQuarterBudgetSum.useQuery({ financialYear: financialYear, quarter: "q2",departmentId:userData.data?.user.departmentId }, { enabled: !!cat && !catsLoading })
    useEffect(() => {
