...
const cols = ['Name', 'Code', 'Type', 'CreatedAt']
...
export default function CostRateReport() {
      ...
      <div className="flex justify-center">
        <div className='shadow-md container rounded-md m-2 p-2'>
          ...
          <div className="flex justify-between items-center mb-1">
              <span className="font-semibold">Cost Rate ({records.length})</span>
              <div className=" w-80 ">
                <SearchInput placeholder="Search Cost rate"
                  className="p-2"
                />
              </div>
